...
\begin{tikzpicture}[thick,shorten >=0mm,shorten <=0mm,draw=black]
  ...
  \begin{scope}[xshift=4\cellw]
    ...
    \draw[-,dashed](mid1|-hautgauche1)to(0,-45\cellh);
    \begin{scope}[xshift=13\cellw,thick]
      \baseCminor
      \begin{scope}[xshift=8\cellw,yshift=-15\cellh]
        \tab{2,1,1,1,0,0,0,0,0};
      ...
      % step 4
      \begin{scope}[xshift=23\cellw,thick]
        \baseCminor
        \begin{scope}[xshift=7\cellw,yshift=-15\cellh]
          ...
          \begin{pgfonlayer}{background}[thick,shorten >=0mm,shorten <=0mm]
            ...
            to[out=20,in=160] node[below=3\cellh](mid3){\color{black}\scriptsize \texttt{(Sseq s\_parms s\_locvarinit)}} (hautgauche);
          \end{pgfonlayer}
          \draw[-,dashed,thick](mid3|-hautgauche1) to (mid3|-basgauche);
          \node (spbproc) at (-3.5\cellw,15\cellh) {\scriptsize\texttt{spb\_proc}};
        ...
        \begin{scope}[xshift=20\cellw,thick]
          ...
          \begin{pgfonlayer}{background}[thick,shorten >=0mm,shorten <=0mm]
            ...
            to[out=20,in=160] node[below=3\cellh](mid4){\color{black}\scriptsize \texttt{s\_pbdy}} (hautgauche);
          \end{pgfonlayer}
          \draw[-,dashed,thick](mid4|-hautgauche1) to (mid4|-basgauche);
          ...
          \begin{scope}[xshift=20\cellw,thick]
            ...
            \begin{pgfonlayer}{background}[thick,shorten >=0mm,shorten <=0mm]
              ...
              to[out=20,in=160] node[below=3\cellh](mid5){\color{black}\scriptsize \texttt{s\_copyout}} (hautgauche);
            \end{pgfonlayer}
            \draw[-,dashed,thick](mid5|-hautgauche1) to (mid5|-basgauche);
          \end{scope}
        \end{scope}
      \end{scope}
    \end{scope}
